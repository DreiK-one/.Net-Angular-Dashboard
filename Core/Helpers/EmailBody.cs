                            ...
                            <div style=""height: auto;background: linear-gradient(to top, #c9c9ff 50%, #6e6ef6 90%) no-repeat;width:400px;padding:30px"">
                                <div>
                                    <div>
                                        ...
                                        <hr>
                                        <p>You're receiving this e-mail because you requested a password reset for you .NetAngularDashboard account.</p>
                                        ...
                                        administration of .NetAngularDashboard app!</p>
                                    </div>
                                </div>
                            </div>    
                        </body>
